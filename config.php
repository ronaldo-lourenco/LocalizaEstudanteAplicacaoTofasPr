...
$DB_HOST = "sql10.freemysqlhosting.net" ;//$_ENV("DB_HOST") ;
$DB_USER = "sql10740797" ;//$_ENV("DB_USER") ;
$DB_PASSWORD = "gW9ntx4l4e" ;//$_ENV("DB_PASSWORD") ;
$DB_NAME = "sql10740797" ;//$_ENV("DB_NAME") ;
$DB_PORT = "3306" ;//$_ENV("DB_PORT") ;
